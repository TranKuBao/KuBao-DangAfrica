...
from pocsuite3.lib.core.settings import POC_APPNAME_REGEX
from pocsuite3.lib.core.settings import POC_APPVERSION_REGEX
...
def get_poc_appname(code):
    return extract_regex_result(POC_APPNAME_REGEX, code)
